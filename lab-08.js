...
fastify.get("/photos", (request, reply) => {
    ...
    fetch("http://jsonplaceholder.tyicode.com/photos")
        .then(response => {
        ...
        .then(photos1 => {
            reply
                ...
                .send({ error: "", statusCode: 200, photos: photos1 });
        })
        .catch(err => {
            reply
                .code(404)
...
fastify.get("/photos/:id", (request, reply) => {
    ...
    fetch(`http://jsonplaceholder.tyicode.com/photos/${id}`)
        .then(response => {
            return response.json()
        })
        .then(photos1 => {
            reply
                ...
                .send(`<html><body><h1>${photos1}</h1><img src='${photos1}'>`);
        })
        .catch(err => {
            reply
                .code(404)
